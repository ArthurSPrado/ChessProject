...
{
    public Bishop(PieceColor pieceColor, Coordinate position) : base(pieceColor, position)
    {
        Directions = new[] { new[] { 1, 1 }, new[] { -1, -1 }, new[] { 1, -1 }, new[] { -1, 1 } };
    }
    ...
    public override void GetValidMoves(Square[,] boardState)
    {
        ...
        foreach (var direction in Directions)
            SearchPatterns.VerifyLongVectorPossibilities(this, boardState, direction[0], direction[1]);
    }
